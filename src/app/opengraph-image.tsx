...
export const alt = "Halman Thompson — Bespoke Metal Creations";
export const size = {
  width: 1200,
  height: 630,
};
...
/**
 * Branded Open Graph card. Fully self-contained: inline styles only, an inline
 * SVG logo mark, and no external fonts or images (per next/og constraints).
 */
    ...
    (
      <div
        style={{
          ...
          // Subtle warm radial glow to evoke aged metal / showroom lighting.
          backgroundImage:
            "radial-gradient(circle at 50% 38%, rgba(184,134,11,0.20), rgba(26,26,46,0) 60%)",
          position: "relative",
        }}
      >
        {/* Top hairline accent */}
        <div
          style={{
            ...
            height: "6px",
            backgroundImage:
              "linear-gradient(90deg, rgba(184,134,11,0) 0%, #b8860b 50%, rgba(184,134,11,0) 100%)",
          }}
        />
        ...
        <div
          style={{
            ...
            height: "2px",
            backgroundImage:
              "linear-gradient(90deg, rgba(184,134,11,0) 0%, rgba(184,134,11,0.7) 50%, rgba(184,134,11,0) 100%)",
          }}
        />
